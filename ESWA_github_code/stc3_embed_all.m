function [suc,n_msg_bits] = stc3_embed_all(rs_encoded_msg,coverPath,cover_round,rho_p,rho_m,change_p,change_m,cover_QF,stegoPath,usable_DCT_num)
    
    %% 三元STCs 编码
    costs = zeros(3, numel(cover_round), 'single');
    costs(1,:) = rho_m;
    costs(3,:) = rho_p;
