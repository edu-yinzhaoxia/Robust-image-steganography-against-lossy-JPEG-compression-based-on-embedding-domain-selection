function [stc_decoded_msg] = stc3_extract_all(afterchannel_stego_Path,stc_n_msg_bits,tab_m,usable_DCT_num)
%% 根据广义抖动调制机制计算载密元素序列
bits = 8;
cover_spa = imread(afterchannel_stego_Path);
% wechat 截取一个面
% cover_spa = cover_spa(:,:,1);
%
...
G = 1;
n_msg = 0;
code_n = m_block*n_block* usable_DCT_num;
